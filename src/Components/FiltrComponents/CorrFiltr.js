      ...
      <div className="side-pants material">
        ...
        <div>
          <input
            ...
            value="Eldar"
          ></input>
          <label htmlFor="Eldar">Eldar</label>
        </div>
        <div>
          <input
            className="radios"
        ...
        <div>
          <input
            ...
            value="Mitex"
          ></input>
          <label htmlFor="Mitex">Mitex</label>
        </div>
        <div>
          <input
            className="radios"
            ...
            value="Wolbar"
          ></input>
          <label htmlFor="Wolbar">Wolbar</label>
        </div>
      </div>
      <div className="side-pants pants">
        <p className="side-top-h">Тип білизни</p>
        <div>
          <input
            className="radios"
            type="checkbox"
        ...
        <div>
          ...
          ></input>
          <label htmlFor="cors">Корсети</label>
        </div>
        <div>
          <input
            className="radios"
            ...
            value="Ціна тижня"
          ></input>
          <label htmlFor="comb">Комбінації, боді, плаття</label>
        </div>
      </div>
